...
Z-Arch will encrypt and store the PAT locally and to your project's Secret Manager once the project exists. 
...
Z-Arch will encrypt and store the token locally and to your project's Secret Manager once the project exists. 

## Billing
Make sure you have a billing account with a card on file before bootstrapping a Z-Arch project. 
